...
setwd("~/MEGAsync/biocomparadaII/result/Psychotria/Biogeo/")
#######################################################
# SETUP: Arbol y Datos geograficos
#######################################################
# Example files are given below. To run your own data,
# make the below lines point to your own files, e.g.
 trfn = "~/MEGAsync/biocomparadaII/result/final/output/Psychotria.new"
 geogfn = "~/MEGAsync/biocomparadaII/result/final/Psychotria_geo.dat"
...
runslow = TRUE
resfn = "Psychotria_BAYAREAL.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res
...
resfn = "Psychotria_BAYAREALJ.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
