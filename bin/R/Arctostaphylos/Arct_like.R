...
setwd("~/MEGAsync/biocomparadaII/result/Arctostaphylos/Biogeo/")
#######################################################
# SETUP: Arbol y Datos geograficos
#######################################################
# Example files are given below. To run your own data,
# make the below lines point to your own files, e.g.
 trfn = "~/MEGAsync/biocomparadaII/result/final/output/Arctostaphylos.new"
 geogfn = "~/MEGAsync/biocomparadaII/result/final/Arctostaphylos_geo.dat"
